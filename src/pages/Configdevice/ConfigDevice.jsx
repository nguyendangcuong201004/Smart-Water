...
const handlePumpSpeedChange = (newSpeed) => {
  ...
  useEffect(() => {
    const fetchPumpStatus = async () => {
      try {
        const response = await axios.get("https://smart-water-server.vercel.app/api/v1/getPump");
    ...
    const fetchLightStatus = async () => {
      try {
        const response = await axios.get("https://smart-water-server.vercel.app/api/v1/getLight");
    ...
    useEffect(() => {
      ...
      const checkLightAndControl = async () => {
        try {
          const response = await axios.get("https://smart-water-server.vercel.app/api/v1/light-sensor/latest");
          ...
          if (latestLight >= min && latestLight <= max) {
            await axios.post("https://smart-water-server.vercel.app/api/v1/turnOnLight", { value: 1 });
            console.log("Ánh sáng phù hợp, đã bật đèn!");
          } else {
            await axios.post("https://smart-water-server.vercel.app/api/v1/turnOnLight", { value: 0 });
    ...
    useEffect(() => {
      const fetchMoistureThreshold = async () => {
        try {
          const response = await axios.get("https://smart-water-server.vercel.app/api/v1/moisture-threshold/latest");
    ...
    useEffect(() => {
      const fetchLightThreshold = async () => {
        try {
          const response = await axios.get("https://smart-water-server.vercel.app/api/v1/light-threshold/latest");
    ...
    const saveLightThreshold = async () => {
      try {
        await axios.post("https://smart-water-server.vercel.app/api/v1/light-threshold", {
          min: lightMin,
          max: lightMax,
        });
    ...
    const saveMoistureThreshold = async () => {
      try {
        await axios.post("https://smart-water-server.vercel.app/api/v1/moisture-threshold", {
          min: moistureMin,
          max: moistureMax,
        });
  ...
  const sendPumpSpeedToServer = async (speed) => {
    try {
      ...
      await axios.post("https://smart-water-server.vercel.app/api/v1/turnOnPump", {
        value: valueToSend
      });
  ...
  const sendLightIntensityToServer = async (intensity) => {
    try {
      ...
      await axios.post("https://smart-water-server.vercel.app/api/v1/turnOnLight", {
        value: valueToSend
      });
  ...
  const checkMoistureAndControlPump = async () => {
    try {
      const response = await axios.get("https://smart-water-server.vercel.app/api/v1/dht-moisure/latest");
      ...
      if (latestMoisture >= min && latestMoisture <= max) {
        await axios.post("https://smart-water-server.vercel.app/api/v1/turnOnPump", { value: 1 });
        console.log("Trong ngưỡng → Bật bơm");
      } else {
        await axios.post("https://smart-water-server.vercel.app/api/v1/turnOnPump", { value: 0 });
